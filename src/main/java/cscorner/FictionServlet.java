...
public class FictionServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT bookname, price, quantity, authorname FROM fiction";
            ...
            out.println("<title>Fiction Books</title>");
            out.println("<style>");
            ...
            out.println("<h2 class=\"category-heading\">Fiction Books</h2>");
